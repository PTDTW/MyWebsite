  ...
  return (
    <div className="rel flex h:100vh  align-items:center justify-content:center rel overflow:hidden">
      <video autoPlay loop muted className="abs top:0 left:0 w:100% h:100% object:cover z:-1">
        <source src="http://ptdtw.tplinkdns.com:82/api/public/dl/0FH_AUT7/Video/4K%20Nebula%20Sphere%20Hyperspace%20%23AAVFX%20%F0%9F%8C%94%20SPACE%20Moving%20Background.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video>
      <div className="abs top:0 left:0 w:full h:full bg:rgb(26|26|26) opacity:0.8 z:1"></div>
      <div className="rel z:10 text:center color:white">
        <h1 className="f:48px font:bold mb:16px">{"<PTDTW/>"}</h1>
        <p className="f:18px">嘗試用新學會的前端框架，親手搭建的個人網站</p>
      </div>
    </div>
...
const MyFileSection = () => {
  return (
    <>
      <div className="position:relative overflow:y:none bg:#0d0c0c5a mt:25px ml:20px mr:20px r:10px px:18px py:8px w:45%">
