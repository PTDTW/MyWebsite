    ...
    return (
        <>
            {teams.map((item, index) => (
                <div key={index} className="bg:#0d0c0c5a ml:5px mr:5px border:1px|rgb(40|40|40)|solid w:420px r:6px h:150px hflex flex-direction:column justify-content:space-between h:auto@<xs mb:10px@<lg ml:0px@<2xs mr:0px@<2xs w:100%@<xs">
                    <div>
